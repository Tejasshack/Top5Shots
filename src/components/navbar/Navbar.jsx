        ...
        >
          ...
          {auth?.user ? (
            <li className="flex items-center space-x-2 mt-4 md:mt-0">
              <h1 className="bg-white font-mono text-purple-600 px-4 py-2 rounded-full font-semibold shadow-md hover:bg-gray-200 transition">
                {auth?.user?.firstName}
              </h1>
              <button
                className="bg-purple-600 cursor-pointer font-mono text-white px-4 py-2 rounded-full font-semibold shadow-md hover:bg-purple-500 transition"
